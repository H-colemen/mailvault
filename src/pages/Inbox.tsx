...
export default function Inbox() {
  ...
  const handleBulkAction = (action: "read" | "unread" | "archive" | "trash" | "spam") => {
    if (selectedEmails.size === 0) return;
    bulkActionMutation.mutate({ ids: Array.from(selectedEmails), action });
  };
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            {searchQuery ? (
              ...
              <>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Emails sent to your domain will appear here
                </p>
              </>
            )}
          </div>
